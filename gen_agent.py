...
class GenerativeAgent(BaseModel):
    ...
    def summarize_related_memories(self, observation: str) -> str:
        ...
        if self.verbose: print(f'In summarize_related_memories: Get realtionship between {self.name} and {entity_name}')
        # q1 and q2 two are used to query the memory for relavant memories
